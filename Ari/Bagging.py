...
df_test.head()
test_feats = df_test.drop("P1", axis=1)
test_feats = test_feats.drop("P4", axis=1)
test_feats = test_feats.drop("P6", axis=1)
test_feats = test_feats.drop("P8", axis=1)
test_feats = test_feats.drop("P9", axis=1)
test_feats = test_feats.drop("P10", axis=1)
test_feats = test_feats.drop("P11", axis=1)
...
test_feats = test_feats.drop("P19", axis=1)
test_feats = test_feats.drop("P20", axis=1)
test_feats = test_feats.drop("P21", axis=1)
test_feats = test_feats.drop("P22", axis=1)
test_feats = test_feats.drop("P23", axis=1)
test_feats = test_feats.drop("P24", axis=1)
test_feats = test_feats.drop("P25", axis=1)
test_feats = test_feats.drop("P27", axis=1)
test_feats = test_feats.drop("P28", axis=1)
test_feats = test_feats.drop("P29", axis=1)
...
feats = feats.drop("P1", axis=1)
feats = feats.drop("P4", axis=1)
feats = feats.drop("P6", axis=1)
feats = feats.drop("P8", axis=1)
feats = feats.drop("P9", axis=1)
feats = feats.drop("P10", axis=1)
feats = feats.drop("P11", axis=1)
...
feats = feats.drop("P19", axis=1)
feats = feats.drop("P20", axis=1)
feats = feats.drop("P21", axis=1)
feats = feats.drop("P22", axis=1)
feats = feats.drop("P23", axis=1)
feats = feats.drop("P24", axis=1)
feats = feats.drop("P25", axis=1)
feats = feats.drop("P27", axis=1)
feats = feats.drop("P28", axis=1)
feats = feats.drop("P29", axis=1)
